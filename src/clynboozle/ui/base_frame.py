...
class BaseFrame(tk.Frame, ABC):
    ...
    def resize(self) -> None:
        ...
        new_button_width = max(
            int(self.active_widgets['base_button_width'] * scale),
            WindowConfig.MIN_BUTTON_WIDTH
        )
        new_button_height = max(
            int(self.active_widgets['base_button_height'] * scale),
            WindowConfig.MIN_BUTTON_HEIGHT
        )
